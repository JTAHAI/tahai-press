...
const required = [
  'README.md', 'LICENSE', 'NOTICE', 'CHANGELOG.md', 'SUPPORT.md', 'CITATION.cff', '.gitattributes',
...
for (const link of ['https://github.com/JTAHAI/tahai-press', 'https://tahai.net', 'https://tahai-press.tahai.net']) {
